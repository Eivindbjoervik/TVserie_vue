...
public class TvSerie {
    ...
    public TvSerie(String tvTittel) {}
    ...
    public TvSerie leggTilEpisode(Episode episoden) {
    ...
    public Episode finnEpisode(int sesongNr, int episodeNr) {
    ...
    public void setGjennomSnittligSpilletid(int gjennomSnittligSpilletid) {
